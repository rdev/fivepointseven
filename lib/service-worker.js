...
export default async function initServiceWorker() {
	if ('serviceWorker' in navigator) {
		...
		log(
			"You don't have a service worker capability. Sad. It won't be as lightning fast here as it could've been.",
		);
	}
}
