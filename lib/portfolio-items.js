...
const portfolioItems: Project[] = [
	...
	},
	{
		...
		slug: 'webcomp',
		brief:
			"WebComp is a ”batteries included” JavaScript library inspired by React for writing smart reusable Web Components in a modern way. It provides all of the sweet features you're used to in React without the need for actual React.",
		scopes: ['dev'],
		image: '/static/work/previews/webcomp.jpg',
		url: 'https://github.com/webcomp/webcomp',
	},
	{
		name: 'MyPlate',
		color: '#06c288',
